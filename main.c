...
int lerTemp() {
    ADCON0bits.GO_DONE = 1; 			    // Inicia a conversï¿½o A/D
    while (ADCON0bits.GO_DONE);  			// Fim da Conversï¿½o
...
void main(void) {
    ...
    // configuracao do AD
    TRISAbits.TRISA1 = 1; // AN1 ï¿½ entrada
    ADCON1 = 0b00001101; // Habilita AN0 e AN1, Vref+=Vcc e Vref?=Vss
    ADCON0 = 0b00000101; // Seleciona AN1 e liga mï¿½dulo A/D
    ADCON2 = 0b10010101; // Resultado alinhado ï¿½ direita TACQ = 4TAD e TAD = FOSC/16
